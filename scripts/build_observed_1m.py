...
from sm_attribution.preprocess.observations import era5land_to_1m_monthly_halfdeg_v1

def main():
    ap = argparse.ArgumentParser(description="Build observed 0–1 m monthly 0.5° datasets")
    ap.add_argument("--dataset", required=True, choices=["era5land"])
